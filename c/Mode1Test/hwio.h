...
#define PORT_MODE1_TILE_IMAGE_START  _SFR_IO16(0x28)
#define PORT_MODE1_MAP_DATA_START  _SFR_IO16(0x2A)
#define PORT_MODE1_MAP_LINE_INCREMENT  _SFR_IO8(0x2C)
#define PORT_MODE1_PALETTES_START  _SFR_IO16(0x2D)
#define PORT_MODE1_SHIFT  _SFR_IO8(0x2F)
