...
#define PORT_VOICE_SELECT  _SFR_IO8(0x60)
#define PORT_MASTER_VOLUME  _SFR_IO8(0x61)

#define PORT_VOICE_FREQ  _SFR_IO16(0x68)
#define PORT_VOICE_FREQ_L  _SFR_IO8(0x68)
#define PORT_VOICE_FREQ_H  _SFR_IO8(0x69)
#define PORT_VOICE_VOLUME  _SFR_IO8(0x6A)
#define PORT_VOICE_WAVE_SHAPE  _SFR_IO8(0x6B)
#define PORT_VOICE_BEND_WAVE  _SFR_IO8(0x6C)
#define PORT_VOICE_BEND_AMPLITUDE  _SFR_IO8(0x6D)
#define PORT_VOICE_NOISE_HOLD  _SFR_IO8(0x6E)
#define PORT_VOICE_ATTACK_RELEASE  _SFR_IO8(0x6F)
...
void fillRect(uint16_t x,uint16_t y, uint8_t w, uint8_t h,uint8_t color);
...
void renderRamString(uint8_t x, uint8_t y,const char* s, uint8_t attribute,  uint16_t textPage, uint8_t pageWidth, uint8_t pageHeight  );

void renderProgMemString(uint8_t x, uint8_t y,const char* s, uint8_t attribute,  uint16_t textPage, uint8_t pageWidth, uint8_t pageHeight  );
